...
class OrnsteinUhlenbeckNoise:
    ...
    def __call__(self):
        x = self.x_prev - self.theta * (self.x_prev - self.mu) * self.dt + \
...
def train(mu, mu_target, q, q_target, memory, q_optimizer, mu_optimizer):
    for i in range(10):
        ...
        target = r + gamma * q_target(s_prime, mu_target(s_prime)) * done
